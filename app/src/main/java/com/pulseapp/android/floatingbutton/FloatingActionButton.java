package com.pulseapp.android.floatingbutton;
...
public class FloatingActionButton extends ImageButton {
    ...
    void init(Context context, AttributeSet attributeSet) {
        ...
        mColorNormal = attr.getColor(R.styleable.FloatingActionButton_fab_colorNormal, getColor(R.color.pulse_button_color));
        mColorPressed = attr.getColor(R.styleable.FloatingActionButton_fab_colorPressed, getColor(R.color.pulse_pressed_button_color));
