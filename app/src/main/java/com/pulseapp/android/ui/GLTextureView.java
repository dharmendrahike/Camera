package com.pulseapp.android.ui;
...
public class GLTextureView extends TextureView implements
    ...
    public interface EGLContextFactory {
        ...
        EGLContext createContext(EGL10 egl, EGLContext sharedContext, EGLDisplay display, EGLConfig eglConfig);
    ...
    private class DefaultContextFactory implements EGLContextFactory {
        ...
        public EGLContext createContext(EGL10 egl, EGLDisplay display, EGLConfig config) {
            return createContext(egl, null, display, config);
        }

        public EGLContext createContext(EGL10 egl, EGLContext sharedContext, EGLDisplay display, EGLConfig config) {
            ...
            if (view == null) {
                ...
                */
                if(mEglContext == null) {
                    ...
                    mEglContext = view.mEGLContextFactory.createContext(mEgl, mEglContext, mEglDisplay, mEglConfig);
                }
            }
