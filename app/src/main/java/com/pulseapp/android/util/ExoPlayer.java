...
public class ExoPlayer implements com.google.android.exoplayer.ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
         ...
         */
        void buildRenderers(ExoPlayer player, RendererBuilderCallback callback);
    }
    ...
    public int getPlaybackState() {
        if (rendererBuildingState == RENDERER_BUILDING_STATE_BUILDING) {
            return com.google.android.exoplayer.ExoPlayer.STATE_PREPARING;
        }
    ...
    private class InternalRendererBuilderCallback implements RendererBuilderCallback {
        ...
        public void onRenderers(String[][] trackNames, MultiTrackChunkSource[] multiTrackSources,
                                TrackRenderer[] renderers, BandwidthMeter bandwidthMeter) {
            if (!canceled) {
                ExoPlayer.this.onRenderers(trackNames, multiTrackSources, renderers, bandwidthMeter);
            }
        }
        ...
        public void onRenderersError(Exception e) {
            if (!canceled) {
                ExoPlayer.this.onRenderersError(e);
            }
        }
